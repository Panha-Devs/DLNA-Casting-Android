package com.example.dlna_casting_android.fragment
...
import com.example.dlna_casting_android.DetailContainer
...
class DeviceServiceActionFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.fragment_device_service_action, container, false)
    }
