...
open class DLNAContentService : AndroidUpnpServiceImpl() {
    ...
    protected inner class RendererServiceBinderWrapper : AndroidUpnpServiceImpl.Binder(),
    ...
    protected open fun generateLocalServices(): Array<LocalService<*>> {
        ...
        val contentDirectoryService =
            serviceBinder.read(AbstractContentDirectoryService::class.java) as LocalService<AbstractContentDirectoryService>
        contentDirectoryService.manager = object :
